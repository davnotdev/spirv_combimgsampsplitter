...
void b(texture2D mixed_texture, sampler regular_sampler, sampler comparison_sampler, texture2D other_b) {
...
void a(texture2D mixed_texture, sampler regular_sampler, sampler comparison_sampler, texture2D other_b) {
    b(mixed_texture, regular_sampler, comparison_sampler, other_b);
}

void main() {
    a(u_mixed_texture, u_regular_sampler, u_comparison_sampler, u_other_b);
    b(u_mixed_texture, u_regular_sampler, u_comparison_sampler, u_other_b);
}
